...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("supportguard.log"),
...
def run_supportguard(customer_query: str) -> dict:
    ...
    logger.info(f"New query received: {customer_query}")
    print("\n" + "="*60)
    ...
    logger.info(f"Query complete | RAS: {arbitration_result['average_ras']} | "
                f"Reliability: {reliability['reliability_score']} | "
